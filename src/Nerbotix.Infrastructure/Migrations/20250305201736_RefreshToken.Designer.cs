...
namespace Nerbotix.Infrastructure.Migrations
{
    ...
    [Migration("20250305201736_RefreshToken")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RoboTasker.Domain.Tasks.Data.RobotTaskBooleanData", b =>
                {
                    b.HasBaseType("RoboTasker.Domain.Tasks.Data.RobotTaskData");
            ...
            modelBuilder.Entity("RoboTasker.Domain.Tasks.Data.RobotTaskDateTimeData", b =>
                {
                    b.HasBaseType("RoboTasker.Domain.Tasks.Data.RobotTaskData");
                    ...
                    b.ToTable("task_data", t =>
                        {
                            t.Property("Value")
                                .HasColumnName("RobotTaskDateTimeData_Value");
                        });

                    b.HasDiscriminator().HasValue(5);
                });

            modelBuilder.Entity("RoboTasker.Domain.Tasks.Data.RobotTaskFileData", b =>
                {
                    b.HasBaseType("RoboTasker.Domain.Tasks.Data.RobotTaskData");
            ...
            modelBuilder.Entity("RoboTasker.Domain.Tasks.Data.RobotTaskJsonData", b =>
                {
                    b.HasBaseType("RoboTasker.Domain.Tasks.Data.RobotTaskData");
                    ...
                    b.ToTable("task_data", t =>
                        {
                            t.Property("Value")
                                .HasColumnName("RobotTaskJsonData_Value");
                        });

                    b.HasDiscriminator().HasValue(4);
                });

            modelBuilder.Entity("RoboTasker.Domain.Tasks.Data.RobotTaskNumberData", b =>
                {
                    b.HasBaseType("RoboTasker.Domain.Tasks.Data.RobotTaskData");
                    ...
                    b.ToTable("task_data", t =>
                        {
                            t.Property("Value")
                                .HasColumnName("RobotTaskNumberData_Value");
                        });

                    b.HasDiscriminator().HasValue(2);
                });

            modelBuilder.Entity("RoboTasker.Domain.Tasks.Data.RobotTaskStringData", b =>
                {
                    b.HasBaseType("RoboTasker.Domain.Tasks.Data.RobotTaskData");
                    ...
                    b.ToTable("task_data", t =>
                        {
                            t.Property("Value")
                                .HasColumnName("RobotTaskStringData_Value");
                        });
